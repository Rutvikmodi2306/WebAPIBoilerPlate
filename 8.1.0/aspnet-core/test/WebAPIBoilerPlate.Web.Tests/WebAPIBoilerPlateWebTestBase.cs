...
{
    public abstract class WebAPIBoilerPlateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WebAPIBoilerPlateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WebAPIBoilerPlateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WebAPIBoilerPlateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WebAPIBoilerPlateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WebAPIBoilerPlateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WebAPIBoilerPlateDbContext, Task<T>> func)
        {
            T result;
