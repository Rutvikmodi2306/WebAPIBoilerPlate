...
namespace WebAPIBoilerPlate.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = WebAPIBoilerPlateConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(WebAPIBoilerPlateDbContext context)
        {
            _context = context;
        }
